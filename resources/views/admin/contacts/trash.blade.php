                        ...
                        <tbody>
                            @foreach (@$contacts as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.contacts.restore', ['id' => $item->id]) }}"
                                            class="btn btn-success mb-2">RESTORE</a>
                                        <a href="{{ route('dashboard.contacts.destroy', ['id' => $item->id]) }}"
                                            class="btn btn-danger mb-2">DESTROY</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
