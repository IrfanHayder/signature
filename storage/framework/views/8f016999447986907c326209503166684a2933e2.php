            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="users_table" class="table dt-responsive nowrap w-100  order-column">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $signatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <td><?php echo e($loop->index+1); ?></td> 
                              <td><?php echo e($sign->name); ?></td>
                              <td><?php echo e($sign->phone); ?></td>
                              <td><?php echo e($sign->email); ?></td>
                              ...
                              <td>
                                <?php if(isset($sign) && isset($sign->signed)): ?>
                                   <a href="<?php echo e($sign->signed); ?>"> <img src="<?php echo e($sign->signed); ?>" alt="signatures" class="" height="50px" width="50px"/></a>
                                <?php endif; ?>
                              </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\All laravel\signature\resources\views/list.blade.php ENDPATH**/ ?>