            ...
            <div class="col-md-12 offset-md-3 ml-0 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                         ...
                         <?php endif; ?>
                         <form method="POST" action="<?php echo e(route('signaturepad.upload')); ?>" enctype="multipart/form-data" id="signatureForm">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('components.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\All laravel\signature\resources\views/signaturePad.blade.php ENDPATH**/ ?>